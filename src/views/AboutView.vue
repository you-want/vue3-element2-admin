<template>
  <div>
    <div class="card mb10">
      ...
      <span class="text">
        <el-link type="primary" href="" target="_blank">Admin</el-link>
        一款基于 Vue3、TypeScript、Vite5、Pinia、Element-Plus 开源的后台管理框架，使用目前最新技术栈开发。项目提供强大的
        <el-link type="primary" href="" target="_blank">ProTable 组件</el-link>
