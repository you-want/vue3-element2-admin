...
import type { TableProProps } from '@/components/TablePro/TablePro.vue'
...
export type TableProInstance = Omit<
  InstanceType<typeof TablePro>,
  keyof ComponentPublicInstance | keyof TableProProps
>
