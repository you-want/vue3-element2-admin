...
import Maximize from "./components/MaximizeIndex.vue";
import Tabs from "@/layouts/components/Tabs/TabsIndex.vue";
import Footer from "@/layouts/components/Footer/FooterIndex.vue";
